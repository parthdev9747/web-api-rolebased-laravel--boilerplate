                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            <td class="min-w-125px">Group Name</td>
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td>{{ date('Y-m-d H:i:s', strtotime($permission->created_at))}}</td>
                            <td class="text-end">
                                <!--begin::Update-->
                                <a href="{{ route('permission.edit', $permission->id) }}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
                                ...
                                <!--end::Update-->
                                <!--begin::Delete-->
                                <a href="{{ route('permission.remove', $permission->id) }}" class="btn btn-icon btn-active-light-primary w-30px h-30px">
