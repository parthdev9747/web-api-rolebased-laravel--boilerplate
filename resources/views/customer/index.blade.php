        ...
        <div class="card card-flush">
            ...
            <div class="card-header mt-6">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    @can('user-create')
                    <a href="{{ route('customers.create') }}" class="btn btn-light-primary">
...
<script>
    $(document).ready(function() {
        ...
        var oTable = $('#kt_permissions_table').DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            searching: true,
            ...
            columns: [{
...

                {
                    ...
                    render: function(o) {
                        ...
                        element +=
                            `@can($modulePermissionPrefix."edit")
                                <a href="{{ $module_route }}/${o.id}/edit" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            @endcan`;
                        element +=
                            `@can($modulePermissionPrefix."delete")
                                <button onclick="deleteUser(${o.id})" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" style="border: none !important;background: none;">
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
