            ...
            <div class="card-body pt-0">
                <form method="POST" action="{{ route('permission.update', $permission->id) }}">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-solid" placeholder="Enter a group name" name="group_name" value="{{ $permission->group_name }}" required />
                        @error('group_name')
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-solid" placeholder="Enter a permission name" name="name" value="{{ $permission->name }}" required />
                        @error('name')
                        <span class="error" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
