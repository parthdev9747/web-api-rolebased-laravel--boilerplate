            ...
            <div class="card-header mt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('roles.create') }}" class="btn btn-light-primary">
                        ...
                        <!--end::Svg Icon-->Add Role</a>@endcan
                    <!--end::Button-->
                </div>
                <!--end::Card toolbar-->
            </div>
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <!--begin::Update-->
                                @can('role-edit')
                                <a href="{{ route('roles.edit', $role->id) }}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
                                ...
                                <!--begin::Delete-->
                                @can('role-delete')
                                <a href="{{ route('roles.remove', $role->id) }}" class="btn btn-icon btn-active-light-primary w-30px h-30px">
